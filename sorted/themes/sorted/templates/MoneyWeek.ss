...
$MetaTags(true)
<meta property="og:url" content="{$BaseHref}{$Top.URLSegment}" />
...
<% if $URLSegment == 'moneyweek' %>
  <link rel="stylesheet" href="/themes/sorted/assets/css/moneyweek.css">
<% end_if %>
<!-- endinject -->
...
<script>
  var videoEmbed = '<iframe width="560" height="315" src="https://www.youtube.com/embed/$YoutubeID.RAW?rel=0&showinfo=0&fs=1&autoplay=1&enablejsapi=1" frameborder="0" allowfullscreen></iframe>';
</script>
...
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <script src="/themes/sorted/javascript/TweenMax.min.js"></script>
        <script src="/themes/sorted/javascript/ScrollToPlugin.min.js"></script>
        <script src="/themes/sorted/javascript/moneyweek.js"></script>
