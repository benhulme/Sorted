(function(){
  ...
  describe('Directive: Popular Tools', function(){
    ...
    function compileDirective() {
      element = angular.element('<popular-tools></popular-tools>');
    ...
    describe('Initialization', function(){
      ...
      it('should compile without throwing any errors', function() {
        var success = jasmine.createSpy('toolsPromiseSuccess');
        var fail = jasmine.createSpy('toolsPromiseFail');

        var directive = compileDirective();
        silverStripeService.get('popularTools').then(success, fail);
      ...
      it('should set the data to the view if the service is successful', function() {
        ...
        expect(scope.tools).toBeDefined(promiseSuccess.data);
      });
